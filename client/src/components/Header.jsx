...
const Header = () => {
  ...
  const [catNavMobile, setCatnavMobile] = useState();
  return (
        ...
        <div className="flex flex-row gap-4 lg:items-center justify-between mb-4 xl:mb-0">
          ...
          <div className="flex items-center gap-x-[10px]">
            <div className="hidden xl:flex uppercase">
              Precisa de ajuda? (47) 98866-1111
            </div>
            <div
              onClick={() => setIsOpen(!isOpen)}
              className="relative cursor-pointer">
              <SlBag className="text-2xl" />
              <div className="bg-accent text-primary absolute w-[18px] h-[18px] rounded top-3 -right-1 text-[13px] flex justify-center items-center font-bold tracking-[-0.1em]">
                {itemsAmount}
              </div>
            </div>
            <div
